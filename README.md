...
Would You Rather Project is a simple react web application to asking users to answer quiz. The user can answer quiz by selecting first option or second option. The user also able to create new quiz and view the leader board.
...
```
https://github.com/wahfebrianto/reactnd-project-would-you-rather-starter.git
...
└── src
    ...
    ├── Error404.js # Application's 404 error page component file.
    ├── index.css # Global styles. You probably won't need to change anything here.
    ├── index.js # You should not need to modify this file. It is used for DOM rendering only.
    ├── reducers.js # Root of all reducers that used in this application.
    └── sagas.js # Root of all sagas that used in this application.

```

## Backend Server

The `_DATA.js` file represents a fake database and methods that let this application access the data.
...
This application will talk to the database via 4 methods:
